...
process.load("PhysicsTools/TagAndProbe/tag_probe_muon_reco_eff_cfi" )
...
process.TPEdm = cms.EDProducer("TagProbeEDMNtuple",
    ...
    allProbeCandTags  = cms.untracked.VInputTag( cms.InputTag("tkProbeCands") ),
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string("Reco_eff_tpedm_ntuple_example.root"),
