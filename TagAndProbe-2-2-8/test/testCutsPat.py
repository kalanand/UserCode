...
#  Zee no cut
process.ZeeNoCut = cms.EDFilter("PatElectronSelection",
                                  src = cms.untracked.string('selectedLayer1Electrons'),
                                  etMin = cms.untracked.double(20.0),
                                  histogramFile = cms.string('pat-hist-Zee_noCut.root')
                                  )


#  ZeeOffline
process.ZeeOffline = cms.EDFilter("PatElectronSelection",
                                  src = cms.untracked.string('selectedLayer1Electrons'),
                                  etMin = cms.untracked.double(20.0),
                                  ...
                                  histogramFile = cms.string('pat-hist-ZeeOffline.root')
                                  )


#  ZeeOnline
process.ZeeOnline = cms.EDFilter("PatElectronSelection",
                                 src = cms.untracked.string('selectedLayer1Electrons'),
                                 etMin = cms.untracked.double(20.0),
                                 ...
                                 sigmaEtaEtaCutBarrel = cms.untracked.double(0.010),
                                 sigmaEtaEtaCutEndcaps = cms.untracked.double(0.028),
                                 histogramFile = cms.string('pat-hist-ZeeOnline.root')
                                 )
...
#  WenuOffline
process.WenuOffline = cms.EDFilter("PatElectronSelection",
                                   src = cms.untracked.string('selectedLayer1Electrons'),
                                   ...
                                   sigmaEtaEtaCutEndcaps = cms.untracked.double(0.028),
                                   histogramFile = cms.string('pat-hist-WenuOffline.root')
                                   )


#  WenuOnline
process.WenuOnline = cms.EDFilter("PatElectronSelection",
                                  src = cms.untracked.string('selectedLayer1Electrons'),
                                  etMin = cms.untracked.double(30.0),
                                  requireTrigMatch = cms.untracked.bool(True),
                                  tkIsoCutBarrel = cms.untracked.double(2.2),
                                  ...
                                  sigmaEtaEtaCutBarrel = cms.untracked.double(0.0099),
                                  sigmaEtaEtaCutEndcaps = cms.untracked.double(0.028),
                                  histogramFile = cms.string('pat-hist-WenuOnline.root')
                                  )
...
process.patSequences = cms.Sequence(process.patLayer0 + process.patLayer1)
...
process.electron_sequence = cms.Sequence( process.AllProbe20 * process.AllProbe30 * process.ZeeNoCut *
...
process.lepton_cands = cms.Sequence( process.sc_sequence * process.iso_sequence * process.patSequences *
...
process.outpath = cms.OutputModule("PoolOutputModule",
                                   ...
                                   fileName = cms.untracked.string('/uscms_data/d2/kalanand/Summer08-Zee/Georgios/testCuts.root')
                                   )
