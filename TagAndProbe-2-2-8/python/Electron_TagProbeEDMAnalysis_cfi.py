...
demo = cms.EDAnalyzer("TagProbeEDMAnalysis",
    ...
    NameVar2 = cms.untracked.string('etaDet'),
    ...
    NameVar1 = cms.untracked.string('etDet'),
    NumBkgPass = cms.untracked.vdouble(1000.0, 0.0, 10000.0),
    NumBinsVar1 = cms.untracked.int32(10),
    ## NumBinsVar2 = cms.untracked.int32(25),
    ...
    Var1High = cms.untracked.double(120.0),
    ...
    Var2BinBoundaries = cms.untracked.vdouble(-2.5,-2.3,-2.1,-1.9,-1.7,-1.5,-1.2,-0.9,-0.6,-0.3,0,0.3,0.6,0.9,1.2,1.5,1.7,1.9,2.1,2.3,2.5),
