...
#******************   definitions  **********************************
DIR_PATH =  "/uscms/home/kalanand/cms/electron/efficiency/CMSSW_2_2_1/src/PhysicsTools/TagAndProbe/test/"
...
for sample in range(0,4):
     ...
     file.write("'file:/uscms_data/d2/kalanand/Summer08-Zee/Georgios/ntuple_Summer08_ridigi_1.root', 'file:/uscms_data/d2/kalanand/Summer08-Zee/Georgios/ntuple_Summer08_ridigi_2.root', 'file:/uscms_data/d2/kalanand/Summer08-Zee/Georgios/ntuple_Summer08_ridigi_3.root', 'file:/uscms_data/d2/kalanand/Summer08-Zee/Georgios/ntuple_Summer08_ridigi_4.root'")     
     file.write(") \n")
     file.write(") \n")
