...
/////// Are you running over data or MC ???
    TCut preCut("mcTrue && tag_gsfEle_ecalDrivenSeed>0 && tag_sc_et>20. && mass>60. && mass<120. && tag_gsfEle_missingHits<=1");
    //TCut preCut("");
   ...
   TCut ID80("probe_passingId80 && probe_sc_et>20. && probe_gsfEle_ecalDrivenSeed>0 && probe_gsfEle_missingHits<1 && !(abs(probe_gsfEle_dist)<0.02 && abs(probe_gsfEle_dcot)<0.02) && tag_gsfEle_missingHits<1 && !(abs(tag_gsfEle_dist)<0.02 && abs(tag_gsfEle_dcot)<0.02)");
   TCut NotID80("probe_sc_et>20. && tag_gsfEle_missingHits<1 && !(abs(tag_gsfEle_dist)<0.02 && abs(tag_gsfEle_dcot)<0.02) && !(probe_passingId80 && probe_gsfEle_missingHits<1 && !(abs(probe_gsfEle_dist)<0.02 && abs(probe_gsfEle_dcot)<0.02))");
