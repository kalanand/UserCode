...
// Wed Jul  6 16:25:18 2011 by ROOT version 5.27/06b
// from TTree WJet/V+jets Tree
// found on file: /uscms_data/d2/kalanand/WjjTrees/WmunuJets_DataAll_GoldenJSON_953invpb.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uscms_data/d2/kalanand/WjjTrees/WmunuJets_DataAll_GoldenJSON_953invpb.root");
      if (!f) {
         f = new TFile("/uscms_data/d2/kalanand/WjjTrees/WmunuJets_DataAll_GoldenJSON_953invpb.root");
      }
