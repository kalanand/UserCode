...
void makeplotsMu ()
{
  ...
  TFile *file0 = TFile::Open("data/WmunuJets_DataAll_GoldenJSON_953invpb.root");
  TTree* tree = (TTree*) file0->Get("WJet");
  tree->SetAlias("dijetPt", dijetPt);

  TFile *file1 = TFile::Open("data/WmunuJets_CMSSW423-Summer11MC_WJets.root");
  TTree* treeMC_WJets = (TTree*) file1->Get("WJet");
  treeMC_WJets->SetAlias("dijetPt", dijetPt);

  TFile *file2 = TFile::Open("data/WmunuJets_CMSSW415-Spring11MC_WWtoAnything.root");
  TTree* treeMC_WW_munujj = (TTree*) file2->Get("WJet");
  treeMC_WW_munujj->SetAlias("dijetPt", dijetPt);

  TFile *file3 = TFile::Open("data/WmunuJets_CMSSW415-Spring11MC_WZtoAnything.root");
  TTree* treeMC_WZ_munujj = (TTree*) file3->Get("WJet");
  treeMC_WZ_munujj->SetAlias("dijetPt", dijetPt);

  TFile *file4 = TFile::Open("data/WmunuJets_CMSSW415-Spring11MC_TTToLNu2Q2B.root");
...
///////////// cuts 
  TCut WleptPre("JetPFCor_Pt[0]>30. && JetPFCor_Pt[1]>30. && JetPFCor_Pt[2]<0.5 && abs(JetPFCor_Eta[0]-JetPFCor_Eta[1])<1.5 && W_muon_pt>25. && abs(W_muon_eta)<2.1 && (W_muon_trackiso+W_muon_hcaliso+W_muon_ecaliso-event_RhoForLeptonIsolation*3.141592653589*0.09)/W_muon_pt<0.1 && abs(W_muon_d0bsp)<0.02 && JetPFCor_bDiscriminator[0]<1.19 && JetPFCor_bDiscriminator[1]<1.19 && cosJacksonAngle2j_PFCor<0.8 && cosJacksonAngle2j_PFCor>-0.6");
...
// ################# How many good W+jj are there ?
  ...
  TH1D* h_wmt_WW_munujj = new TH1D("h_wmt_WW_munujj","", 60, 40, 160);
  h_wmt_WW_munujj->SetFillColor(kOrange);
  TH1D* h_wmt_WZ_munujj = h_wmt_WW_munujj->Clone("h_wmt_WZ_munujj");
  treeMC_WW_munujj->Draw( "W_mt>>h_wmt_WW_munujj", goodW, "goff");
  h_wmt_WW_munujj->Scale( WW_scale );
  treeMC_WZ_munujj->Draw( "W_mt>>h_wmt_WZ_munujj", goodW, "goff");
  h_wmt_WZ_munujj->Scale( WZ_scale );
  h_wmt_WW_munujj->Add(h_wmt_WZ_munujj);
...
//////////////////////////////////////////////////////////
  ...
  TH1D* h_wmet_WW_munujj = new TH1D("h_wmet_WW_munujj","", 50, 0, 100);
  h_wmet_WW_munujj->SetFillColor(kOrange);
  TH1D* h_wmet_WZ_munujj = h_wmet_WW_munujj->Clone("h_wmet_WZ_munujj");
  treeMC_WW_munujj->Draw( "event_met_pfmet>>h_wmet_WW_munujj", WleptPre && "W_mt>40.", "goff");
  h_wmet_WW_munujj->Scale( WW_scale );
  treeMC_WZ_munujj->Draw( "event_met_pfmet>>h_wmet_WZ_munujj", WleptPre && "W_mt>40.", "goff");
  h_wmet_WZ_munujj->Scale( WZ_scale );
  h_wmet_WW_munujj->Add(h_wmet_WZ_munujj);
  ...
  h_wmet_WW_munujj->Add(h_wmet_TT);
  h_wmet_WJets->Add(h_wmet_WW_munujj);
  h_wmet->SetMaximum( 1.3 * h_wmet->GetMaximum() );
  h_wmet->Draw("e");
  h_wmet_WJets->Draw("same");
  h_wmet_TT->Draw("same");
  h_wmet_WW_munujj->Draw("same");
  h_wmet->Draw("esame");
  c_wmet->RedrawAxis();
  TLegend* legend = new TLegend(0.55,0.7,0.89,0.89);
  legend->SetFillColor(0);
  legend->AddEntry(h_wmet, "Data", "PLE");  
  legend->AddEntry(h_wmet_WW_munujj, "WW/WZ#rightarrow l#nujj", "F");
  ...
  ar2->SetFillColor(1);
  ar2->Draw();
  c_wmet->SaveAs("Wmunu-met.gif");
  c_wmet->SaveAs("Wmunu-met.pdf");
...
///////////////////////////////////////////////////////////////////////////
  ...
  TH1D* h_dijetPt_WW_munujj = new TH1D("h_dijetPt_WW_munujj","", 50, 0, 500);
  h_dijetPt_WW_munujj->SetFillColor(kOrange);
  TH1D* h_dijetPt_WZ_munujj = h_dijetPt_WW_munujj->Clone("h_dijetPt_WZ_munujj");
  treeMC_WW_munujj->Draw( "dijetPt>>h_dijetPt_WW_munujj", goodW, "goff");
  h_dijetPt_WW_munujj->Scale( WW_scale );
  treeMC_WZ_munujj->Draw( "dijetPt>>h_dijetPt_WZ_munujj", goodW, "goff");
  h_dijetPt_WZ_munujj->Scale( WZ_scale );
  h_dijetPt_WW_munujj->Add(h_dijetPt_WZ_munujj);
  ...
  h_dijetPt_WW_munujj->Add(h_dijetPt_TT);
  h_dijetPt_WJets->Add(h_dijetPt_WW_munujj);
  h_dijetPt->SetMaximum( 1.3 * h_dijetPt->GetMaximum() );
  h_dijetPt->Draw("e");
  h_dijetPt_WJets->Draw("same");
  h_dijetPt_WW_munujj->Draw("same");
  ...
  legend->AddEntry(h_dijetPt_WW_munujj, "WW/WZ#rightarrow l#nujj", "F");
  ...
  ar2->SetFillColor(1);
  ar2->Draw();
  c_dijetPt->SaveAs("Wmunu-dijetPt.gif");
  c_dijetPt->SaveAs("Wmunu-dijetPt.pdf");
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
//   c_wy->SaveAs("W-rapidity.gif");
  ...
  TH1D* h_jjmass_WW_munujj = new TH1D("h_jjmass_WW_munujj","", jjmass_NBINS, jjmass_MIN, jjmass_MAX);
  h_jjmass_WW_munujj->SetFillColor(kOrange);
  TH1D* h_jjmass_WZ_munujj = h_jjmass_WW_munujj->Clone("h_jjmass_WZ_munujj");
...
//   h_jjmass_WJets->GetListOfFunctions()->Add(st);
  ...
  treeMC_WW_munujj->Draw("Mass2j_PFCor>>h_jjmass_WW_munujj", allCuts, "goff");
  h_jjmass_WW_munujj->Scale( WW_scale );
  treeMC_WZ_munujj->Draw("Mass2j_PFCor>>h_jjmass_WZ_munujj", allCuts, "goff");
  h_jjmass_WZ_munujj->Scale( WZ_scale );
  h_jjmass_WW_munujj->Add(h_jjmass_WZ_munujj);
//  h_jjmass_WW_munujj->Smooth(1000);
  h_jjmass_WW_munujj->Draw("sames");
//   gPad->Update();
//   st = (TPaveStats*)h_jjmass_WW_munujj->FindObject("stats");
//   st->SetFillColor(kOrange);
//   st->SetName("stats3");
//   st->SetY1NDC(0.68); //new y start position
//   st->SetY2NDC(0.83); //new y end position
//   st->SetOptStat(1100);
//   h_jjmass_WW_munujj->GetListOfFunctions()->Add(st);
...
// ################# How many good W+jj are there ?
  ...
  cout << "Number of WW events predicted from MC = " <<  h_jjmass_WW_munujj->Integral()/10. << endl;
...
//   h_jjmass_WW_munujj->GetXaxis()->SetRangeUser(60., 100.);
//   cout << "Signal events in 60--100 GeV mass window = " << h_jjmass_WW_munujj->Integral() << endl;  
...
//   TH1D* h_jjdeta_WW_munujj = new TH1D("h_jjdeta_WW_munujj","", 10*jjdeta_NBINS, jjdeta_MIN, jjdeta_MAX);
//   h_jjdeta_WW_munujj->SetFillColor(kOrange);
//   TH1D* h_jjdeta_WZ_munujj = h_jjdeta_WW_munujj->Clone("h_jjdeta_WZ_munujj");
//   treeMC_WW_munujj->Draw( TString(jjdeta)+TString(">>h_jjdeta_WW_munujj"), goodW, "goff");
//   h_jjdeta_WW_munujj->Scale( 10*WW_scale );
//   treeMC_WZ_munujj->Draw( TString(jjdeta)+TString(">>h_jjdeta_WZ_munujj"), goodW, "goff");
//   h_jjdeta_WZ_munujj->Scale( 10*WZ_scale );
//   h_jjdeta_WW_munujj->Add(h_jjdeta_WZ_munujj);
//   h_jjdeta_WW_munujj->Smooth(1000);
//   // h_jjdeta->SetMaximum( 1.15 * h_jjdeta_WJets->GetMaximum() );
//   h_jjdeta->Draw("e");
//   h_jjdeta_WJets->Draw("same");
//   h_jjdeta_WW_munujj->Draw("same");
...
//   cout << "#### Number of W+jj events = " << integral << endl;
  ...
  TH1D* h_jjcostheta_WW_munujj = new TH1D("h_jjcostheta_WW_munujj","", 4*20, -1, 1);
  h_jjcostheta_WW_munujj->SetFillColor(kOrange);
  TH1D* h_jjcostheta_WZ_munujj = h_jjcostheta_WW_munujj->Clone("h_jjcostheta_WZ_munujj");
  treeMC_WW_munujj->Draw( TString(jjcostheta)+TString(">>h_jjcostheta_WW_munujj"), goodW && twojets && dphicut, "goff");
  h_jjcostheta_WW_munujj->Scale( 4*WW_scale );
  treeMC_WZ_munujj->Draw( TString(jjcostheta)+TString(">>h_jjcostheta_WZ_munujj"), goodW && twojets && dphicut, "goff");
  h_jjcostheta_WZ_munujj->Scale( 4*WZ_scale );
  h_jjcostheta_WW_munujj->Add(h_jjcostheta_WZ_munujj);
  h_jjcostheta_WW_munujj->Smooth(1000);
  h_jjcostheta->SetMaximum( 2. * h_jjcostheta->GetMaximum() );
  h_jjcostheta->Draw("e");
  h2_jjcostheta->Draw("esame");
  h_jjcostheta_WJets->Draw("same");
  h_jjcostheta_WW_munujj->Draw("same");
  ...
  TH1D* h_jjdphi_WW_munujj = new TH1D("h_jjdphi_WW_munujj","", 4*jjdphi_NBINS, jjdphi_MIN, jjdphi_MAX);
  h_jjdphi_WW_munujj->SetFillColor(kOrange);
  TH1D* h_jjdphi_WZ_munujj = h_jjdphi_WW_munujj->Clone("h_jjdphi_WZ_munujj");
  treeMC_WW_munujj->Draw( TString(jjdphi)+TString(">>h_jjdphi_WW_munujj"), goodW && twojets && centrality && dphicut1M2M, "goff");
  h_jjdphi_WW_munujj->Scale( 4*WW_scale );
  treeMC_WZ_munujj->Draw( TString(jjdphi)+TString(">>h_jjdphi_WZ_munujj"), goodW && twojets && centrality && dphicut1M2M, "goff");
  h_jjdphi_WZ_munujj->Scale( 4*WZ_scale );
  h_jjdphi_WW_munujj->Add(h_jjdphi_WZ_munujj);
  h_jjdphi_WW_munujj->Smooth(1000);
  // h_jjdphi->SetMaximum( 10 * h_jjdphi_WJets->GetMaximum() );
  h_jjdphi->SetMinimum(0);
  h_jjdphi->Draw("e");
  h_jjdphi_WJets->Draw("same");
  h_jjdphi_WW_munujj->Draw("same");
  // c_jjdphi->SetLogy();
  c_jjdphi->RedrawAxis();
  ...
  TH1D* h_j1dphiMET_WW_munujj = new TH1D("h_j1dphiMET_WW_munujj","", 4*jjdphi_NBINS, jjdphi_MIN, jjdphi_MAX);
  h_j1dphiMET_WW_munujj->SetFillColor(kOrange);
  TH1D* h_j1dphiMET_WZ_munujj = h_j1dphiMET_WW_munujj->Clone("h_j1dphiMET_WZ_munujj");
  treeMC_WW_munujj->Draw( "abs(JetPFCor_dphiMET[0])>>h_j1dphiMET_WW_munujj", goodW && twojets && centrality && dphicut122M, "goff");
  h_j1dphiMET_WW_munujj->Scale( 4*WW_scale );

  treeMC_WZ_munujj->Draw( "abs(JetPFCor_dphiMET[0])>>h_j1dphiMET_WZ_munujj", goodW && twojets && centrality && dphicut122M, "goff");
  h_j1dphiMET_WZ_munujj->Scale( 4*WZ_scale );
  h_j1dphiMET_WW_munujj->Add(h_j1dphiMET_WZ_munujj);
  h_j1dphiMET_WW_munujj->Smooth(1000);
  // h_j1dphiMET->SetMaximum( 10 * h_j1dphiMET_WJets->GetMaximum() );
  h_j1dphiMET->SetMinimum(0);
  h_j1dphiMET->Draw("e");
  h_j1dphiMET_WJets->Draw("same");
  h_j1dphiMET_WW_munujj->Draw("same");
  // c_j1dphiMET->SetLogy();
...
//   TH1D* h_j2dphiMET_WW_munujj = new TH1D("h_j2dphiMET_WW_munujj","", 4*jjdphi_NBINS, jjdphi_MIN, jjdphi_MAX);
//   h_j2dphiMET_WW_munujj->SetFillColor(kOrange);
//   treeMC_WW_munujj->Draw( "abs(JetPFCor_dphiMET[1])>>h_j2dphiMET_WW_munujj", goodW && twojets && centrality && dphicut121M, "goff");
//   h_j2dphiMET_WW_munujj->Smooth(1000);
//   h_j2dphiMET_WW_munujj->Scale( 4*WW_scale );
//   h_j2dphiMET->SetMaximum( 10 * h_j2dphiMET_WJets->GetMaximum() );
//   h_j2dphiMET->Draw("e");
//   h_j2dphiMET_WJets->Draw("same");
//   h_j2dphiMET_WW_munujj->Draw("same");
//   c_j2dphiMET->SetLogy();
...
//   TH1D* h_edphiMET_WW_munujj = new TH1D("h_edphiMET_WW_munujj","", 4*jjdphi_NBINS, jjdphi_MIN, jjdphi_MAX);
//   h_edphiMET_WW_munujj->SetFillColor(kOrange);
//   treeMC_WW_munujj->Draw( TString(eMETdphi)+TString(">>h_edphiMET_WW_munujj"), goodW && twojets && centrality && dphicut, "goff");
//   h_edphiMET_WW_munujj->Smooth(1000);
//   h_edphiMET_WW_munujj->Scale( 4*WW_scale );
//   h_edphiMET->SetMaximum( 10 * h_edphiMET_WJets->GetMaximum() );
//   h_edphiMET->Draw("e");
//   h_edphiMET_WJets->Draw("same");
//   h_edphiMET_WW_munujj->Draw("same");
//   c_edphiMET->SetLogy();
...
//   c_edphiMET->SaveAs("edphiMET.gif");
  ...
  TH1D* h_dphiWjj_WW_munujj = new TH1D("h_dphiWjj_WW_munujj","", 4*jjdphi_NBINS, jjdphi_MIN, jjdphi_MAX);
  h_dphiWjj_WW_munujj->SetFillColor(kOrange);
  TH1D* h_dphiWjj_WZ_munujj = h_dphiWjj_WW_munujj->Clone("h_dphiWjj_WZ_munujj");
  treeMC_WW_munujj->Draw( TString(dphiWjj)+TString(">>h_dphiWjj_WW_munujj"), goodW && twojets && centrality && dphicut, "goff");
  h_dphiWjj_WW_munujj->Scale( 4*WW_scale );
  treeMC_WZ_munujj->Draw( TString(dphiWjj)+TString(">>h_dphiWjj_WZ_munujj"), goodW && twojets && centrality && dphicut, "goff");
  h_dphiWjj_WZ_munujj->Scale( 4*WZ_scale );
  h_dphiWjj_WW_munujj->Add(h_dphiWjj_WZ_munujj);
  h_dphiWjj_WW_munujj->Smooth(1000);
...
//   TH1D* h_ej1dphi_WW_munujj = new TH1D("h_ej1dphi_WW_munujj","", 4*jjdphi_NBINS, jjdphi_MIN, jjdphi_MAX);
//   h_ej1dphi_WW_munujj->SetFillColor(kOrange);
//   treeMC_WW_munujj->Draw( TString(ej1dphi)+TString(">>h_ej1dphi_WW_munujj"), goodW && twojets && centrality && dphicut, "goff");
//   h_ej1dphi_WW_munujj->Smooth(1000);
//   h_ej1dphi_WW_munujj->Scale( 4*WW_scale );
//   h_ej1dphi->SetMaximum( 10 * h_ej1dphi_WJets->GetMaximum() );
//   h_ej1dphi->Draw("e");
//   h_ej1dphi_WJets->Draw("same");
//   h_ej1dphi_WW_munujj->Draw("same");
//   c_ej1dphi->SetLogy();
...
//   TH1D* h_ej2dphi_WW_munujj = new TH1D("h_ej2dphi_WW_munujj","", 4*jjdphi_NBINS, jjdphi_MIN, jjdphi_MAX);
//   h_ej2dphi_WW_munujj->SetFillColor(kOrange);
//   treeMC_WW_munujj->Draw( TString(ej2dphi)+TString(">>h_ej2dphi_WW_munujj"), goodW && twojets && centrality && dphicut, "goff");
//   h_ej2dphi_WW_munujj->Smooth(1000);
//   h_ej2dphi_WW_munujj->Scale( 4*WW_scale );
//   h_ej2dphi->SetMaximum( 10 * h_ej2dphi_WJets->GetMaximum() );
//   h_ej2dphi->Draw("e");
//   h_ej2dphi_WJets->Draw("same");
//   h_ej2dphi_WW_munujj->Draw("same");
//   c_ej2dphi->SetLogy();
...
//   TH1D* h_numTags_WW_munujj = new TH1D("h_numTags_WW_munujj","", 3, -0.5, 2.5);
//   h_numTags_WW_munujj->SetFillColor(kOrange);
//   treeMC_WW_munujj->Draw("numPFCorJetBTags>>h_numTags_WW_munujj", goodW && twojets && centrality && dphicut, "goff");
//   h_numTags_WW_munujj->Scale( WW_scale );
//   h_numTags->SetMaximum( 10 * h_numTags_WJets->GetMaximum() );
//   h_numTags->Draw("e");
//   h_numTags_WJets->Draw("same");
//   h_numTags_WW_munujj->Draw("same");
//   c_numTags->SetLogy();
