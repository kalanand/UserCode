...
//    char* plotDir = "enujjPlots/";
  ...
  TFile *file0 = TFile::Open("Histo_Data_WenuJets_2011_178invpb_May6JSON.root");
  TH1F* h_jjmass = (TH1F*) file0->Get("hh_lvjj_kkmjj");
  h_jjmass->SetMarkerStyle(20);


  TFile *file1 = TFile::Open("Histo_MC_WJets_enujj_Spring11.root");
  TH1F* h_jjmass_WJets = (TH1F*) file1->Get("hh_lvjj_kkmjj");
  h_jjmass_WJets->SetFillColor(2);

  TFile *file2 = TFile::Open("Histo_MC_WW_enujj_Spring11.root");
  TH1F* h_jjmass_WW_enujj = (TH1F*) file2->Get("hh_lvjj_kkmjj");
  h_jjmass_WW_enujj->SetFillColor(kOrange);

  TFile *file3 = TFile::Open("Histo_MC_WZ_enujj_Spring11.root");
  TH1F* h_jjmass_WZ_enujj = (TH1F*) file3->Get("hh_lvjj_kkmjj");

  TFile *file4 = TFile::Open("Histo_MC_TT_enujj_Spring2011.root");
...
////////////////////////////////////////////////////////////////////////
 ...
 TF1 *func1 = new TF1("func1", "[0]*(219.8/1772.46)*((1-x/7000.)^[1])/(x^[2])", 40., 1000.);
 ...
 TF1 *func2 = new TF1("func2", "TMath::BreitWigner(x,[0],[1])*[2]*(5538./608.)", 40., 220.);
//TF1 *func2 = new TF1("func2", "TMath::BreitWigner(x,[0],[1])*[2]", 40., 220.);
 ...
 h_jjmass->SetMaximum(450.);
 h_jjmass->SetOption("E");
 h_jjmass->Draw("e");
 TF1 *func3 = new TF1("func3", "[0]*(5538./608.)*TMath::BreitWigner(x,76.34,29.21)+ [1]*(219.8/1772.46)*((1-x/7000.)^83)/(x^1.23)", 40., 220.);
...
// func3->SetParameter(1, 1.0);
 h_jjmass->Fit("func3","LLI", "", 50.0, 200.0);
 TF1 *func4 = new TF1("func4", "5.25403e+05*(219.8/1772.46)*((1-x/7000.)^83)/(x^1.23)", 40., 220.);
